import { BOOT } from './runtime-config.js?v=36';
import { portraitFileFor as registeredPortraitFileFor, portraitTextureKeyFor } from './portrait-registry.js?v=36';
import { safeText, titleize } from './text.js?v=36';
