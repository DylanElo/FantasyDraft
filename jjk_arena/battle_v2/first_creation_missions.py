...
FIRST_CREATION_MISSIONS: tuple[dict[str, object], ...] = (
    ...
    },
    {
        ...
        "description": "Win with Todo, Kamo, and Mai leaning on marks and ranged pressure to prove Kyoto-side fundamentals.",
        "recommended_team": ["aoi_todo", "noritoshi_kamo", "mai_zenin"],
        "objectives": ["Win the match", "Apply Blood Mark with Noritoshi's Blood-Tipped Arrow", "Fire Mai's Revolver Shot"],
    ...
    },
    {
        ...
        "objectives": ["Win the match", "Trigger Quick Draw Stun with Miwa's New Shadow Quick Draw", "Reveal an enemy with Momo's Aerial Scout"],
    ...
    },
    {
        ...
        "objectives": ["Win the match", "Enter Gorilla Core with Panda", "Apply Crow Mark with Mei Mei's Crow Scout"],
