import { SocketClient } from './network/socket-client.js?v=18';
import { GameStore } from './store/game-store.js?v=18';
import { SCENE_LIST } from './scenes/scene-registry.js?v=18';
