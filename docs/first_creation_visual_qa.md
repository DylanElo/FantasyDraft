...
The maintained runtime cache version is `43`. Evidence is current only when it
...
The older v27/v28/v42 Season 3 packs are historical evidence and do not satisfy
the v43 release gate. See `docs/phaser_asset_delivery_contract.md` for the exact
