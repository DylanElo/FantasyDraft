...
class Skill:
    ...
    description: str
    cooldown: str
    energy: List[str]  # green=Physical, red=Bloodline, blue=CurseEnergy, white=Strategic, black=General
    classes: str       # Physical / Bloodline / Energy / Strategic + Instant / Action
...
#
#  POWER SCALE (matches Naruto Arena):
#   1 energy  → basic attack
#   2 energy  → moderate technique
#   3 energy  → Domain Expansion / Maximum technique (cd 3-4)
# ──────────────────────────────────────────────────────────────────────────────
