import { BOOT } from './runtime-config.js?v=38';
import { portraitFileFor as registeredPortraitFileFor, portraitTextureKeyFor } from './portrait-registry.js?v=38';
import { safeText, titleize } from './text.js?v=38';
