import { BOOT } from './runtime-config.js?v=37';
import { portraitFileFor as registeredPortraitFileFor, portraitTextureKeyFor } from './portrait-registry.js?v=37';
import { safeText, titleize } from './text.js?v=37';
